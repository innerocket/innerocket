  ...
  useEffect(() => {
    ...
    fileTransfers.forEach((transfer) => {
      ...
      if (
        ...
        showNotification(
          `File "${transfer.fileName}" has been ${
            transfer.sender === myPeerId ? 'sent' : 'received'
          } successfully!`,
          'success'
        );
      }
      ...
      if (
        ...
        showNotification(
          `Failed to ${
            transfer.sender === myPeerId ? 'send' : 'receive'
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-700">
                  ...
                  peer IDs, then select the file and send it directly to them.
                </p>
              </div>
            </div>
          </div>
