...
import { Zap, Globe, Server, Shield, ArrowRight, Check, Info, Wifi, Settings } from 'lucide-solid'
    ...
    <div class='space-y-4'>
      <div class='flex items-center justify-between'>
        <div class='flex items-center space-x-2'>
          ...
          <h4 class='text-lg font-medium text-gray-900 dark:text-white'>Connection Method</h4>
      ...
      <div class='rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-700 dark:bg-blue-900/20'>
        ...
        <Show when={props.connectedPeers().length > 0}>
          <div class='mt-3 text-xs text-blue-600 dark:text-blue-300'>
            <strong>Active connections:</strong> {props.connectedPeers().length} peer(s) using this
            method
          </div>
        </Show>
      </div>
                ...
                >
                  <div class='flex items-center justify-between'>
                    ...
                    >
                      {isSelected() ? (
                        <Check
                          class={`h-4 w-4 text-${colorScheme}-600 dark:text-${colorScheme}-400`}
                        />
                      ) : (
      ...
      <div class='rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-700 dark:bg-blue-900/20'>
        ...
        <div class='mt-2 space-y-1 text-xs text-blue-700 dark:text-blue-400'>
          <p>
            • <strong>Corporate/School networks:</strong> Use TURN or Adaptive Fallback
          </p>
          <p>
            • <strong>Home networks:</strong> Direct P2P usually works best
          </p>
          <p>
            • <strong>Mobile hotspots:</strong> Relay or TURN methods recommended
          </p>
          <p>
            • <strong>VPN connections:</strong> TURN method may be required
          </p>
          <p>
            • <strong>Public WiFi:</strong> Use Automatic or Adaptive Fallback
          </p>
        </div>
      </div>
    </div>
