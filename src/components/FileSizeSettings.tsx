    ...
    <div class='space-y-4'>
      <div class='flex items-center justify-between'>
        <div class='flex items-center space-x-2'>
          ...
          <h4 class='text-lg font-medium text-gray-900 dark:text-white'>File Size Limits</h4>
      ...
      <div class='text-sm text-gray-600 dark:text-gray-400'>
        <p class='mb-2'>
          <strong>Auto-accept behavior:</strong> When auto-accept is enabled, only files within the
          size limit will be automatically accepted.
        </p>
        <p>
          <strong>Security note:</strong> File size limits apply to both manual and automatic file
          acceptance.
        </p>
      </div>
      ...
      <Show when={isUnlimited()}>
        <div class='rounded-lg border border-orange-200 bg-orange-50 p-4 dark:border-orange-700 dark:bg-orange-900/20'>
          <div class='flex items-center space-x-2'>
            ...
            <h5 class='text-sm font-medium text-orange-800 dark:text-orange-300'>No Size Limit</h5>
          </div>
          <p class='mt-2 text-sm text-orange-700 dark:text-orange-400'>
            Files of any size will be accepted. Consider setting a limit for better performance and
            security.
          </p>
        </div>
      </Show>
      ...
      {/* Preset options */}
      <div class='space-y-3'>
        <h5 class='text-sm font-medium text-gray-700 dark:text-gray-300'>Quick Size Presets</h5>
              ...
              return (
                ...
                >
                  <div class='flex items-center justify-center space-x-1'>
                    {isSelected() && <Check class='h-4 w-4 text-blue-600 dark:text-blue-400' />}
      ...
      {/* Custom size input */}
      <div class='space-y-3'>
        <h5 class='text-sm font-medium text-gray-700 dark:text-gray-300'>Custom Size Limit</h5>
      ...
      <div class='rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-700/20'>
        ...
        <div class='grid grid-cols-1 gap-2 text-xs text-gray-600 sm:grid-cols-2 dark:text-gray-400'>
          <div class='space-y-1'>
            <div>
              <strong>10MB:</strong> High-quality photos, small videos
            </div>
            <div>
              <strong>50MB:</strong> Short video clips, presentations
            </div>
            <div>
              <strong>100MB:</strong> Medium videos, software packages
            </div>
          </div>
          <div class='space-y-1'>
            <div>
              <strong>500MB:</strong> Long videos, large datasets
            </div>
            <div>
              <strong>1GB:</strong> HD movies, game files
            </div>
            <div>
              <strong>5GB:</strong> Very large files, OS images
            </div>
          </div>
        </div>
      </div>
