    ...
    <div class='space-y-4'>
      <div class='flex items-center justify-between'>
        <div class='flex items-center space-x-2'>
          ...
          <h4 class='text-lg font-medium text-gray-900 dark:text-white'>Privacy Settings</h4>
      ...
      <div class='text-sm text-gray-600 dark:text-gray-400'>
        ...
        <p>
          <strong>Security note:</strong> Even in normal mode, all data stays on your device and is
      ...
      <div class='rounded-lg border border-gray-200 p-4 dark:border-gray-700'>
        ...
        <div class='mt-4 text-sm text-gray-600 dark:text-gray-400'>
          <p class='mb-2'>
            <strong>Normal mode:</strong> Connection history, statistics, and transfer records are
            saved locally for your reference.
          </p>
          <p>
            <strong>Privacy mode:</strong> No connection history is tracked or saved. All existing
            history is immediately cleared.
          </p>
        </div>
      </div>
        ...
        <div class='rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-700 dark:bg-blue-900/20'>
          ...
          <div class='mt-3 rounded border border-blue-300 bg-blue-100 p-2 text-xs text-blue-800 dark:border-blue-600 dark:bg-blue-800/20 dark:text-blue-200'>
            <div class='flex items-center space-x-1'>
              <Lock class='h-3 w-3' />
              <span>
                <strong>Enhanced Privacy:</strong> All existing history has been cleared
              </span>
            </div>
          </div>
        </div>
      ...
      <Show when={!props.privacyMode()}>
        <div class='rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-700 dark:bg-blue-900/20'>
          <div class='flex items-center space-x-2'>
            ...
            <h5 class='text-sm font-medium text-blue-800 dark:text-blue-300'>Normal Mode Active</h5>
          </div>
          <p class='mt-2 text-sm text-blue-700 dark:text-blue-400'>
      ...
      <div class='rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-700/20'>
        ...
        <div class='space-y-2 text-xs text-gray-600 dark:text-gray-400'>
          ...
          <p>
            <strong>Your control:</strong> You can enable/disable history tracking or clear all data
            at any time.
          </p>
          <p>
            <strong>Secure transfers:</strong> File transfers remain end-to-end encrypted regardless
            of privacy mode settings.
          </p>
        </div>
      </div>
    </div>
